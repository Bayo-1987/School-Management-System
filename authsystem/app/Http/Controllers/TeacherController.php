...
class TeacherController extends Controller
{
    ...
    {
        $teacherData = User::latest()->where('role', 'teacher')->paginate(5);
        return view('backend.manage_teachers', compact('teacherData'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $teacherData->save();
        return redirect()->back()->with('SuccessMsg', 'Teacher successfully registered');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $teacherupdate->save();
        return redirect()->back()->with('SuccessMsg', 'Teacher successfully updated');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('SuccessMsg', 'Records of teacher successfully deleted');
