...
<main>
            <div class="container-fluid px-4">
                 <h1 class="mt-4">Manage Junior Subject</h1>
                        <!--ErrorMsg-->
                        @if ($errors->any())
                    ...
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('junior_subject.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                           <div class="row mb-3">
                                                <div class="col-md-12">
                         ...
                         <td><a href="" data-bs-toggle="modal" data-bs-target="#exampleModal3{{ $subjectDatas->id }}"><i class="fas fa-edit"></i></a> &nbsp;
                            ...
                            <div class="modal fade" id="exampleModal3{{ $subjectDatas->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                 ...
                                                 <form action="{{ route('junior_subject.update', $subjectDatas->id)  }}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    @method('PUT')
                                                    <div class="row mb-3">
                                                        <div class="col-md-12">
                              ...
                              <!--All for edit button-->
                                                    ...
                                                    <form id = "delete-form-{{$subjectDatas->id}}" action="{{ route('junior_subject.destroy', $subjectDatas->id ) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
