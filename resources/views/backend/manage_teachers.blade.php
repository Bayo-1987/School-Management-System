                                         ...
                                         <table class="table table-striped">
                                            ...
                                            <tbody>
                                                                ...
                                                                <form action="{{ route('teacher.update', $teacherDatas->id)  }}" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    @method('PUT')
                                                                        <div class="row mb-3">
                                                                            <div class="col-md-6">
                                                                                <div class="form-floating mb-3 mb-md-0">
                                                                                    <input class="form-control" value="{{ $teacherDatas->name }}" name="name" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                                                    <label for="inputFirstName">First Name</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-floating">
                                                                                    <input class="form-control" value="{{ $teacherDatas->lastname }}" name="lastname" id="inputLastName" type="text" placeholder="Enter your last name" />
                                                                                    <label for="inputLastName">Last name</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6" style="padding-top: 10px;">
                                                                                <div class="form-floating mb-3 mb-md-0">
                                                                                    <input class="form-control" value="{{ $teacherDatas->phone }}" name="phone" id="inputFirstName" type="number" placeholder="Enter your phone number" />
                                                                                    <label for="inputFirstName">Phone</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6"  style="padding-top: 10px;">
                                                                            ...
                                                                            <div class="col-md-6"  style="padding-top: 10px;">
                                                                                <div class="form-floating mb-3 mb-md-0">
                                                                                    <input class="form-control" value="{{ $teacherDatas->date_of_birth }}" name="date_of_birth" id="inputFirstName" type="date" placeholder="Enter your date of birth" />
                                                                                    <label for="inputFirstName">Date of Birth</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-floating mb-3">
                                                                            <input class="form-control" value="{{ $teacherDatas->email }}" name="email" id="inputEmail" type="email" placeholder="name@example.com" />
                                                                            <label for="inputEmail">Email address</label>
                                                                        </div>
                                                                        <div class="row mb-3">
                                                                            <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-floating mb-3">
                                                                            <label for="exampleFormControlTextarea1" class="form-label">Address</label>
                                                                            <textarea class="form-control" name="address" id="exampleFormControlTextarea1" rows="4" placeholder="Address">{{ $teacherDatas->address }}</textarea>
                                                                        </div>
                                                                        <div class="mt-4 mb-0">
                                                ...
                                                <!--All for edit button-->
                                                    ...
                                                    <button href="" type = "button" onclick = "deleteTeacher({{$teacherDatas->id}})"><span style="color: red;"><i class="fas fa-trash"></i></span></button>&nbsp;
                                                    <!--Delete Functionality-->
                                                    <form id = "delete-form-{{$teacherDatas->id}}" action="{{ route('teacher.destroy', $teacherDatas->id ) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                    ...
                                                    <a href=""  data-bs-toggle="modal" data-bs-target="#exampleModal2{{$teacherDatas->id }}"><span style="color:green;"><i class="fas fa-eye"></i></span></a>&nbsp;
                                                    <!--Modal code here-->
                                                    <!-- Modal -->
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <h6>PHOTO</h6>
                                                                        <img src="{{ url('upload/teacherphoto/'.$teacherDatas->image) }}" width="200px" height="185px" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
