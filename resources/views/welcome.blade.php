...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('school/ assets/img/favicon.png')  }}" rel="icon">
  <link href="{{ asset('school/assets/img/apple-touch-icon.png')  }} " rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

  <!-- Vendor CSS Files -->
  <link href="{{ asset('school/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('school/assets/vendor/bootstrap-icons/bootstrap-icons.css') }} " rel="stylesheet">
  <link href="{{ asset('school/assets/vendor/boxicons/css/boxicons.min.css')  }}" rel="stylesheet">
  <link href="{{ asset('school/assets/vendor/glightbox/css/glightbox.min.css') }} " rel="stylesheet">
  <link href="{{ asset('school/ assets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
  <link href="{{ asset('school/assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
...
<body>
  ...
  <!-- Vendor JS Files -->
  <script src="{{ asset('school/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }} "></script>
  <script src="{{ asset('school/assets/vendor/glightbox/js/glightbox.min.js')  }} "></script>
  <script src=" {{asset('school/ assets/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
  <script src="{{ asset('school/ assets/vendor/php-email-form/validate.js')   }}"></script>
  <script src="{{ asset('school/assets/vendor/swiper/swiper-bundle.min.js')  }} "></script>
